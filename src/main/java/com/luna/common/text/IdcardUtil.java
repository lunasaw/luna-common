...
import com.luna.common.regex.PatternPool;
import com.luna.common.regex.ReUtil;
import com.luna.common.regex.Validator;
...
public class IdcardUtil {
    ...
    public static String convert15To18(String idCard) {
        ...
        if (ReUtil.isMatch(PatternPool.NUMBERS, idCard)) {
            ...
            Date birthDate = DateUtils.parseDateDay(birthday);
            // 获取出生年(完全表现形式,如：2010)
    ...
    public static Date getBirthDate(String idCard) {
        ...
        return null == birthByIdCard ? null : DateUtils.parseDateDay(birthByIdCard);
    }
    ...
    public static int getAgeByIdCard(String idcard) {
        return (int)(getAgeByIdCard(idcard, DateUtils.getCurrentDate()) / 365);
    }
    ...
    public static long getAgeByIdCard(String idcard, Date dateToCompare) {
        ...
        return DateUtils.getDaysBetween(DateUtils.parseDateDay(birth), dateToCompare);
    }
    ...
    private static char getCheckCode18(int iSum) {
        switch (iSum % 11) {
            ...
            case 0:
                return '1';
            default:
                return StrPoolConstant.C_SPACE;
        }
    }
