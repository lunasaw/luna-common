...
public class HexUtil {
    ...
    public static String encodeHexStr(String data, Charset charset) {
        return encodeHexStr(CharsetUtil.bytes(data, charset), true);
    }
    ...
    public static String decodeHexStr(String hexStr, Charset charset) {
        ...
        return CharsetUtil.str(decodeHex(hexStr), charset);
    }
    ...
    public static String decodeHexStr(char[] hexData, Charset charset) {
        return CharsetUtil.str(decodeHex(hexData), charset);
    }
    ...
    public static byte[] decodeHex(CharSequence hexData) {
        ...
        hexData = CharsetUtil.cleanBlank(hexData);
    ...
    public static String format(String hexStr) {
        ...
        for (int i = 2; i < length - 1; i += 2) {
            builder.append(CharPoolConstant.SPACE).append(hexStr.charAt(i)).append(hexStr.charAt(i + 1));
        }
        return builder.toString();
    }
