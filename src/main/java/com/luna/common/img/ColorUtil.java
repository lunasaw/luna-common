...
public class ColorUtil {
    ...
    public static Color getColor(String colorName) {
        ...
        if ("BLACK".equals(colorName)) {
            ...
            // rgb值
            final List<String> rgb = Splitter.on(",").splitToList(colorName);
            if (3 == rgb.size()) {
                final Integer r = ConvertUtil.toInt(rgb.get(0));
                final Integer g = ConvertUtil.toInt(rgb.get(1));
                final Integer b = ConvertUtil.toInt(rgb.get(2));
                if (!ObjectUtils.hasNull(r, g, b)) {
    ...
    public static Color hexToColor(String hex) {
        return getColor(Integer.parseInt(StringTools.removeStart(hex, "#"), 16));
    }
    ...
    public static String getMainColor(BufferedImage image, int[]... rgbFilters) {
        ...
        final String[] splitRgbStr = StringTools.split(maxColor, '-');
