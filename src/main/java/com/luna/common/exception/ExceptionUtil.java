...
public class ExceptionUtil {
    ...
    public static String getSimpleMessage(Throwable e) {
        return (null == e) ? StrPoolConstant.EMPTY : e.getMessage();
    }
    ...
    public static String stacktraceToOneLineString(Throwable throwable, int limit) {
        ...
        replaceCharToStrMap.put(StrPoolConstant.C_CR, StrPoolConstant.SPACE);
        replaceCharToStrMap.put(StrPoolConstant.C_LF, StrPoolConstant.SPACE);
        replaceCharToStrMap.put(StrPoolConstant.C_TAB, StrPoolConstant.SPACE);
    ...
    public static <T extends Throwable> T convertFromOrSuppressedThrowable(Throwable throwable, Class<T> exceptionClass,
        ...
        if (ObjectUtils.isNotEmpty(throwables)) {
