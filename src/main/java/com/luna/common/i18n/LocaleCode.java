 ...
 * code = LocaleCode.{@link #getByCode(String, String) getByCode}(<span style="color: darkred;">"es"</span>, <span style
="color: darkred;">"ES"</span>);
 * code = LocaleCode.{@link #getByLocale(Locale) getByLocale}(new Locale(<span style=
"color: darkred;">"pt"</span>, <span style="color: darkred;">"BR"</span>));
 *
